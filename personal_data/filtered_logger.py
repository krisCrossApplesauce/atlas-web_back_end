...
write a func called filter_datum that returns the log message obfuscated:
    > Arguments:
        ...
        >  redaction: a str representing what the field will be obfuscated by
        >  message: a str representing the log line
        >  separator: a str representing which character is separating
           all the fields in the log line (message)
    > The func should use a regex
